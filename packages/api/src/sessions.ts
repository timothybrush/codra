...
export async function createSession(c: Context<ApiEnv>, session: SessionRecord) {
...
export async function destroySession(c: Context<ApiEnv>) {
...
export async function readSession(c: Context<ApiEnv>) {
