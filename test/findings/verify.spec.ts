...
describe('renderDiffSnippet', () => {
  ...
  // It used to fall back to the top of the file's diff, judging the claim against unrelated code.
  // Returning nothing instead lets the caller pass the candidate through unverified.
